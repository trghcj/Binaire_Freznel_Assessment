 ...
 */
declare const ToastRegion: <T>(props: ToastRegionProps<T> & React.RefAttributes<HTMLDivElement>) => ReactElement | null;
...
declare const ToastList: <T>(props: ToastListProps<T> & React.RefAttributes<HTMLOListElement>) => ReactElement | null;
 ...
 * application.
 */
declare const Toast: <T>(props: ToastProps<T> & React.RefAttributes<HTMLDivElement>) => ReactElement | null;
