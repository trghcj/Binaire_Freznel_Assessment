 ...
 */
export declare const Select: <T, M extends SelectionMode = "single">(props: SelectProps<T, M> & React.RefAttributes<HTMLDivElement>) => React.ReactElement | null;
 ...
 */
export declare const SelectValue: <T>(props: SelectValueProps<T> & React.RefAttributes<HTMLSpanElement>) => React.ReactElement | null;
export {};
