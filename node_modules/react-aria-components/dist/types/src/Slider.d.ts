 ...
 */
export declare const Slider: <T extends number | number[]>(props: SliderProps<T> & React.RefAttributes<HTMLDivElement>) => React.ReactElement | null;
 ...
 */
export declare const SliderOutput: (props: SliderOutputProps & React.RefAttributes<HTMLOutputElement>) => React.ReactElement | null;
 ...
 */
export declare const SliderTrack: (props: SliderTrackProps & React.RefAttributes<HTMLDivElement>) => React.ReactElement | null;
 ...
 */
export declare const SliderThumb: (props: SliderThumbProps & React.RefAttributes<HTMLDivElement>) => React.ReactElement | null;
 ...
 */
export declare const SliderFill: (props: SliderFillProps & React.RefAttributes<HTMLDivElement>) => React.ReactElement | null;
export {};
