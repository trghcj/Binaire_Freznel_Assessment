 ...
 */
export declare const TabList: <T>(props: TabListProps<T> & React.RefAttributes<HTMLDivElement>) => React.ReactElement | null;
/**
 * A Tab provides a title for an individual item within a TabList.
 */
export declare const Tab: (props: TabProps & React.RefAttributes<HTMLDivElement>) => React.ReactElement | null;
 ...
 */
export declare const TabPanels: <T>(props: TabPanelsProps<T> & React.RefAttributes<HTMLDivElement>) => React.ReactElement | null;
/**
 * A TabPanel provides the content for a tab.
 */
export declare const TabPanel: (props: TabPanelProps & React.RefAttributes<HTMLDivElement>) => React.ReactElement | null;
