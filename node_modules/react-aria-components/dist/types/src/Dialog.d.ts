 ...
 */
export declare function DialogTrigger(props: DialogTriggerProps): JSX.Element | null;
/**
 * A dialog is an overlay shown above other content in an application.
 */
export declare const Dialog: (props: DialogProps & React.RefAttributes<HTMLElement>) => React.ReactElement | null;
