 ...
 */
export declare const Switch: (props: SwitchProps & React.RefAttributes<HTMLLabelElement>) => React.ReactElement | null;
/**
 * A switch allows a user to turn a setting on or off, with support for validation and help text.
 */
export declare const SwitchField: (props: SwitchFieldProps & React.RefAttributes<HTMLDivElement>) => React.ReactElement | null;
/**
 * A switch button is the clickable area of a switch, including the indicator and label.
 */
export declare const SwitchButton: (props: SwitchButtonProps & React.RefAttributes<HTMLLabelElement>) => React.ReactElement | null;
