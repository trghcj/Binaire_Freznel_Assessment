 ...
 */
export declare const ComboBox: <T, M extends SelectionMode = "single">(props: ComboBoxProps<T, M> & React.RefAttributes<HTMLDivElement>) => ReactElement | null;
 ...
 * to customize this.
 */
export declare const ComboBoxValue: <T>(props: ComboBoxValueProps<T> & React.RefAttributes<HTMLDivElement>) => ReactElement | null;
export {};
