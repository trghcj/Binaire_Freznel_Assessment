 ...
 */
export declare const TokenField: <T extends TokenFieldValue = TokenFieldValue<any>>(props: TokenFieldProps<T> & React.RefAttributes<HTMLDivElement>) => React.ReactElement | null;
/**
 * A token input represents the editable area within a token field.
 */
export declare const TokenInput: <T extends TokenFieldValue = TokenFieldValue<any>>(props: TokenInputProps<T> & React.RefAttributes<HTMLDivElement>) => React.ReactElement | null;
