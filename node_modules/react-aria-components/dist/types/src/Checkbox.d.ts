 ...
 */
export declare const CheckboxField: (props: CheckboxFieldProps & React.RefAttributes<HTMLDivElement>) => React.ReactElement | null;
/**
 ...
 */
export declare const Checkbox: (props: CheckboxProps & React.RefAttributes<HTMLLabelElement>) => React.ReactElement | null;
/**
 * A checkbox button is the clickable area of a checkbox, including the indicator and label.
 */
export declare const CheckboxButton: (props: CheckboxButtonProps & React.RefAttributes<HTMLLabelElement>) => React.ReactElement | null;
