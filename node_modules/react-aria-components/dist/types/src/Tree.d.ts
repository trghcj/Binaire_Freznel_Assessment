 ...
 */
export declare const Tree: <T>(props: TreeProps<T> & React.RefAttributes<HTMLDivElement>) => React.ReactElement | null;
...
export declare const TreeItemContent: (props: TreeItemContentProps & React.RefAttributes<Element>) => React.ReactElement | null;
 ...
 */
export declare const TreeItem: <T extends unknown>(props: TreeItemProps<T> & React.RefAttributes<HTMLDivElement>) => React.ReactElement | null;
...
export declare const TreeLoadMoreItem: <T>(props: TreeLoadMoreItemProps & React.RefAttributes<HTMLDivElement>) => React.ReactElement | null;
 ...
 */
export declare const TreeSection: <T extends unknown>(props: TreeSectionProps<T> & React.RefAttributes<HTMLDivElement>) => React.ReactElement | null;
