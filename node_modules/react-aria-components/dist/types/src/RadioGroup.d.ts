 ...
 */
export declare const RadioGroup: (props: RadioGroupProps & React.RefAttributes<HTMLDivElement>) => React.ReactElement | null;
/**
 * A radio represents an individual option within a radio group.
 *
 * @deprecated Use RadioField + RadioButton instead.
 */
export declare const Radio: (props: RadioProps & React.RefAttributes<HTMLLabelElement>) => React.ReactElement | null;
/**
 * A RadioField represents an individual option within a radio group, containing a RadioButton and
 * optional description.
 */
export declare const RadioField: (props: RadioFieldProps & React.RefAttributes<HTMLDivElement>) => React.ReactElement | null;
/**
 * A RadioButton is the clickable area of a radio, including the indicator and label.
 */
export declare const RadioButton: (props: RadioButtonProps & React.RefAttributes<HTMLLabelElement>) => React.ReactElement | null;
