 ...
 * @version alpha
 */
export declare const SubmenuTrigger: (props: SubmenuTriggerProps & React.RefAttributes<HTMLDivElement>) => ReactElement | null;
 ...
 */
export declare const Menu: <T>(props: MenuProps<T> & React.RefAttributes<HTMLDivElement>) => ReactElement | null;
 ...
 */
export declare const MenuSection: <T>(props: MenuSectionProps<T> & React.RefAttributes<HTMLElement>) => ReactElement | null;
 ...
 */
export declare const MenuItem: <T>(props: MenuItemProps<T> & React.RefAttributes<HTMLDivElement>) => ReactElement | null;
export interface MenuLoadMoreItemProps extends Omit<LoadMoreSentinelProps, 'collection' | 'direction'>, StyleProps, DOMRenderProps<'div', undefined>, GlobalDOMAttributes<HTMLDivElement> {
    /**
     * The CSS [className](https://developer.mozilla.org/en-US/docs/Web/API/Element/className) for the
     * element.
     *
...
export declare const MenuLoadMoreItem: (props: MenuLoadMoreItemProps & React.RefAttributes<HTMLDivElement>) => ReactElement | null;
