 ...
 */
export declare const TagGroup: (props: TagGroupProps & React.RefAttributes<HTMLDivElement>) => React.ReactElement | null;
/**
 * A tag list is a container for tags within a TagGroup.
 */
export declare const TagList: <T>(props: TagListProps<T> & React.RefAttributes<HTMLDivElement>) => React.ReactElement | null;
 ...
 */
export declare const Tag: (props: TagProps & React.RefAttributes<HTMLDivElement>) => React.ReactElement | null;
