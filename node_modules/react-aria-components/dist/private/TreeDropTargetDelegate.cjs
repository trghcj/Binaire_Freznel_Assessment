...
$parcel$export(module.exports, "TreeDropTargetDelegate", function () { return $56f56e0916461149$export$82c13862611c034e; });
const $56f56e0916461149$var$X_SWITCH_THRESHOLD = 10;
const $56f56e0916461149$var$Y_SWITCH_THRESHOLD = 5;
class $56f56e0916461149$export$82c13862611c034e {
    ...
    resolveDropTarget(target, x, y, isValidDropTarget) {
        ...
        if (Math.abs(deltaY) > $56f56e0916461149$var$Y_SWITCH_THRESHOLD) {
            currentYMovement = deltaY > 0 ? 'down' : 'up';
            tracking.yDirection = currentYMovement;
            tracking.lastY = y;
        }
        if (Math.abs(deltaX) > $56f56e0916461149$var$X_SWITCH_THRESHOLD) {
    ...
    selectTarget(potentialTargets, originalTarget, x, y, currentYMovement, currentXMovement) {
        ...
        if (distanceFromLastYSwitch > $56f56e0916461149$var$Y_SWITCH_THRESHOLD && currentYMovement) {
        ...
        if (distanceFromLastXSwitch > $56f56e0916461149$var$X_SWITCH_THRESHOLD && currentXMovement) {
...
//# sourceMappingURL=TreeDropTargetDelegate.cjs.map
