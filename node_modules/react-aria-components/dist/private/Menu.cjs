...
var $fDx7A$reactariaprivateutilsinertValue = require("react-aria/private/utils/inertValue");
var $fDx7A$reactariaprivateutilsuseLoadMoreSentinel = require("react-aria/private/utils/useLoadMoreSentinel");
...
$parcel$export(module.exports, "MenuLoadMoreItem", function () { return $76f9e98b4261ab43$export$93aba29d3a678058; });
/*
...
const $76f9e98b4261ab43$export$93aba29d3a678058 = (0, $fDx7A$reactariaCollectionBuilder.createLeafComponent)((0, $fDx7A$reactariaprivatecollectionsBaseCollection.LoaderNode), function MenuLoadingIndicator(props, ref, item) {
    let state = (0, $fDx7A$react.useContext)($76f9e98b4261ab43$export$24aad8519b95b41b);
    let { isLoading: isLoading, onLoadMore: onLoadMore, scrollOffset: scrollOffset, ...otherProps } = props;
    let sentinelRef = (0, $fDx7A$react.useRef)(null);
    let memoedLoadMoreProps = (0, $fDx7A$react.useMemo)(()=>({
    ...
    (0, $fDx7A$reactariaprivateutilsuseLoadMoreSentinel.useLoadMoreSentinel)(memoedLoadMoreProps, sentinelRef);
    let renderProps = (0, $048d76b84370f141$exports.useRenderProps)({
        ...otherProps,
        id: undefined,
        children: item.rendered,
    ...
    return /*#__PURE__*/ (0, ($parcel$interopDefault($fDx7A$react))).createElement((0, ($parcel$interopDefault($fDx7A$react))).Fragment, null, /*#__PURE__*/ (0, ($parcel$interopDefault($fDx7A$react))).createElement("div", {
        style: {
            position: 'relative',
            width: 0,
            height: 0
        },
        inert: (0, $fDx7A$reactariaprivateutilsinertValue.inertValue)(true)
    }, /*#__PURE__*/ (0, ($parcel$interopDefault($fDx7A$react))).createElement("div", {
    ...
    })), isLoading && renderProps.children && /*#__PURE__*/ (0, ($parcel$interopDefault($fDx7A$react))).createElement((0, ($parcel$interopDefault($fDx7A$react))).Fragment, null, /*#__PURE__*/ (0, ($parcel$interopDefault($fDx7A$react))).createElement((0, $048d76b84370f141$exports.dom).div, {
        ...(0, $fDx7A$reactariamergeProps.mergeProps)((0, $fDx7A$reactariafilterDOMProps.filterDOMProps)(props, {
            global: true
        }), itemProps),
        ...renderProps,
        role: "menuitem",
