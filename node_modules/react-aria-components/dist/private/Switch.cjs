...
const $f78e777132fa7bc2$export$b5d5cf8927ab7262 = /*#__PURE__*/ (0, $goUg1$react.forwardRef)(function Switch(props, ref) {
    ...
    let inputRef = (0, $goUg1$reactariauseObjectRef.useObjectRef)((0, $goUg1$react.useMemo)(()=>(0, $goUg1$reactariamergeRefs.mergeRefs)(userProvidedInputRef, props.inputRef !== undefined ? props.inputRef : null), [
