...
import {CollectionNode as $7xe5e$CollectionNode, SectionNode as $7xe5e$SectionNode, ItemNode as $7xe5e$ItemNode, LoaderNode as $7xe5e$LoaderNode} from "react-aria/private/collections/BaseCollection";
...
import {inertValue as $7xe5e$inertValue} from "react-aria/private/utils/inertValue";
import {useLoadMoreSentinel as $7xe5e$useLoadMoreSentinel} from "react-aria/private/utils/useLoadMoreSentinel";
...
const $49319ee1285aa241$export$93aba29d3a678058 = (0, $7xe5e$createLeafComponent)((0, $7xe5e$LoaderNode), function MenuLoadingIndicator(props, ref, item) {
    let state = (0, $7xe5e$useContext)($49319ee1285aa241$export$24aad8519b95b41b);
    let { isLoading: isLoading, onLoadMore: onLoadMore, scrollOffset: scrollOffset, ...otherProps } = props;
    let sentinelRef = (0, $7xe5e$useRef)(null);
    let memoedLoadMoreProps = (0, $7xe5e$useMemo)(()=>({
    ...
    (0, $7xe5e$useLoadMoreSentinel)(memoedLoadMoreProps, sentinelRef);
    let renderProps = (0, $7230ffa83bc0c2cf$export$4d86445c2cf5e3)({
        ...otherProps,
        id: undefined,
        children: item.rendered,
    ...
    return /*#__PURE__*/ (0, $7xe5e$react).createElement((0, $7xe5e$react).Fragment, null, /*#__PURE__*/ (0, $7xe5e$react).createElement("div", {
        style: {
            position: 'relative',
            width: 0,
            height: 0
        },
        inert: (0, $7xe5e$inertValue)(true)
    }, /*#__PURE__*/ (0, $7xe5e$react).createElement("div", {
    ...
    })), isLoading && renderProps.children && /*#__PURE__*/ (0, $7xe5e$react).createElement((0, $7xe5e$react).Fragment, null, /*#__PURE__*/ (0, $7xe5e$react).createElement((0, $7230ffa83bc0c2cf$export$df3a06d6289f983e).div, {
        ...(0, $7xe5e$mergeProps)((0, $7xe5e$filterDOMProps)(props, {
            global: true
        }), itemProps),
        ...renderProps,
        role: "menuitem",
