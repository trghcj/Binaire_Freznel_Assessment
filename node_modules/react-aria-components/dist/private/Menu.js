...
import {CollectionNode as $gKmcL$CollectionNode, SectionNode as $gKmcL$SectionNode, ItemNode as $gKmcL$ItemNode, LoaderNode as $gKmcL$LoaderNode} from "react-aria/private/collections/BaseCollection";
...
import {inertValue as $gKmcL$inertValue} from "react-aria/private/utils/inertValue";
import {useLoadMoreSentinel as $gKmcL$useLoadMoreSentinel} from "react-aria/private/utils/useLoadMoreSentinel";
...
const $113aa0613e727c6c$export$93aba29d3a678058 = (0, $gKmcL$createLeafComponent)((0, $gKmcL$LoaderNode), function MenuLoadingIndicator(props, ref, item) {
    let state = (0, $gKmcL$useContext)($113aa0613e727c6c$export$24aad8519b95b41b);
    let { isLoading: isLoading, onLoadMore: onLoadMore, scrollOffset: scrollOffset, ...otherProps } = props;
    let sentinelRef = (0, $gKmcL$useRef)(null);
    let memoedLoadMoreProps = (0, $gKmcL$useMemo)(()=>({
    ...
    (0, $gKmcL$useLoadMoreSentinel)(memoedLoadMoreProps, sentinelRef);
    let renderProps = (0, $b7b7a92703138c9b$export$4d86445c2cf5e3)({
        ...otherProps,
        id: undefined,
        children: item.rendered,
    ...
    return /*#__PURE__*/ (0, $gKmcL$react).createElement((0, $gKmcL$react).Fragment, null, /*#__PURE__*/ (0, $gKmcL$react).createElement("div", {
        style: {
            position: 'relative',
            width: 0,
            height: 0
        },
        inert: (0, $gKmcL$inertValue)(true)
    }, /*#__PURE__*/ (0, $gKmcL$react).createElement("div", {
    ...
    })), isLoading && renderProps.children && /*#__PURE__*/ (0, $gKmcL$react).createElement((0, $gKmcL$react).Fragment, null, /*#__PURE__*/ (0, $gKmcL$react).createElement((0, $b7b7a92703138c9b$export$df3a06d6289f983e).div, {
        ...(0, $gKmcL$mergeProps)((0, $gKmcL$filterDOMProps)(props, {
            global: true
        }), itemProps),
        ...renderProps,
        role: "menuitem",
